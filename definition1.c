	...
	int flags, int width, int precision, int size)
{
	...
	return (WriteCharHandle(c, buffer, flags, width, precision, size));
}
/************************* PRINT A STRING *************************/
/**
	...
	int flags, int width, int precision, int size)
{
	...
	return (NumberWrite(is_negative, i, buffer, flags, width, precision, size));
}
